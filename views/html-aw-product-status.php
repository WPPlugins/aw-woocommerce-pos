...
?>
        <tr>
            <td colspan="3" class="load_status"><center><img src="<?php echo WC_POS()->plugin_url();?>/assets/images/<?php echo $icon;?>" /> <span><b><?php echo $teks;?></b></span></center></td>
        </tr>
<?php
if( $status == 'success' ){
        foreach( $data as $title => $value ){
            ...
            if( $title == 'expire date' )
                $value = WC_POS()->convert_date( $value, 'd M Y' );
